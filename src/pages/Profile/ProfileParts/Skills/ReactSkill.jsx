  ...
  return (
    <li className="grid grid-cols-2 justify-center gap-4">
      <div className="text-4xl flex items-center gap-2">
        <svg viewBox="0 0 24 24" fill="#0dd1ee" height="1em" width="1em">
      ...
      <div className="rating rating-lg rating-half">
        <input type="radio" name="react-rating" className="rating-hidden" />
        <input
          type="radio"
          name="react-rating"
          className="bg-[#0dd1ee] mask mask-star-2 mask-half-1"
        />
        <input
          type="radio"
          name="react-rating"
          className="bg-[#0dd1ee] mask mask-star-2 mask-half-2"
        />
        <input
          type="radio"
          name="react-rating"
